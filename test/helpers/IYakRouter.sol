...
interface IYakRouter {
    ...
    function swapNoSplitFromETH(Trade calldata _trade, uint256 _fee, address _to) external payable;

    function swapNoSplitToETH(Trade calldata _trade, uint256 _fee, address _to) external;
